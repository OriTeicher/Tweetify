import { EMPTY_STR, SPACE } from './consts.service'
...
function getInitials(fullName: string) {
    if (!fullName) return
    const nameParts = fullName.split(SPACE)
...
function generateRandomSentences(sentencesCount: number) {
    const sentences = [
        ...
        'CR7 scored the fastest hat-trick in Premier-League history, taking just 4 minutes and 33 seconds to score three goals. ',
        ...
        'Ryan Giggs holds the record for the most Premier-League assists, providing 162 assists during his career. ',
        ...
        'The first-ever Premier-League goal was scored by Brian Deane for Sheffield United vs Manchester-United on August 15, 1992. ',
        'The fastest goal in Premier-League history was scored by Shane Long, who found the net after just 7.69 seconds for Southampton vs Watford in 2019. ',
        'The Premier-League highest-scoring match ended in a 4-4 draw between Tottenham and Arsenal in 2008. ',
        ...
        'In the 2015-2016 season, Leicester City won the Premier-League title despite all odds, having started the season as 5000-1 outsiders. ',
        ...
        'Westham United once signed a player named Paolo Di Canio, who pushed over the referee after being shown a red card. ',
        'Liverpool once played a match vs Sunderland in 2016 where the game had to be stopped temporarily because a black cat ran onto the pitch. ',
...
function getIsUppercaseLetter(char: string) {
